...
$user = "if0_41704562";
$pass = "Meiry8702";
$db   = "if0_41704562_data_driven_web_form";
...
<head>
  ...
  <title>Data Submitted — Cruz De Los Santos</title>
...
<div class="container">
  ...
  <div class="page-intro fade-up">
    ...
    <h1>Data-Driven Web Form</h1>
  </div>

  <div class="wf-card fade-up delay-1">
    <div class="wf-icon">✅</div>
    <h2 class="wf-title">Data Saved Successfully!</h2>
    <p class="wf-desc">Your information has been stored in our database.</p>
    ...
    <div class="wf-result">
      <div class="wf-result-row">
        ...
        <span class="wf-result-value"><?php echo htmlspecialchars($name); ?></span>
      </div>
      <div class="wf-result-row">
    ...
    <a href="webform.html" class="calc-btn"
